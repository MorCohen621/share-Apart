      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="homepage_after_register.php">Create or Join apartment
</a>
          </li>
        ...
        <div class="accordion" id="accordionExample">
          <div class="card">
            <div class="card-header" id="headingOne">
              <h5 class="mb-0">
                <button class="btn btn" type="text" data-toggle="" data-target="#collapseOne" aria-expanded="" aria-controls="collapseOne">
             <h5>
                    <b> To join an existing apartment you must do the following:</b> <br><br>
1. Search for the name / nickname of one of your roommates<br>
2. Click on "Join Apartment"<br>
3. It's time to bother your friends and tell him to approve you soon<br>
4. Reconnect to the site<br>
5. Enjoy!</h5>  
                </button>
              </h5>
            </div>
                ...
                $.post('ask_join_apart.php',   // url
                     ...
                     /*  , // data to be submit
                          function(data, status, jqXHR) {// success callback
                           ...
                           Dont forget to reconnect ");
                            window.location = 'myprofile.php';
                          }*/
                      );
                             window.location = 'assignApartment.php';
                            alert("Your join request has been sent, Please wait until your roommate approves your request. Dont forget to reconnect" );
                            window.location = 'assignApartment.php';
              }
