    ...
    $dbname = "isshanee_shareApart_new";
        ...
        if ($conn->connect_error) {
          ...
          echo "<script>console.log('DB Connection succeded');</script>";
            ...
            $q_notes = "SELECT noteid, n_creator, text, apartmentid, note_title ,note_date FROM notes WHERE apartmentid=(SELECT apartmentid FROM users WHERE username='".$_SESSION['user']."')";
