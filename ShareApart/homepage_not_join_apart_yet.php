        ...
        <div class="row">
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
             ...
             <img src="images/bill.png" height="100" width="100" alt="bills logo" href="bills_to_pay.php">
                  
              </div>
              <a class="card-footer text-white clearfix small z-1" href="bills_to_pay.php">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="chores.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
             ...
             <img src="images/cart.png" height="100" width="100"  alt="cart logo">
              ...
              <a class="card-footer text-white clearfix small z-1" href="shopping.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <a class="card-footer text-white clearfix small z-1" href="calendar1.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
          ...
          <div class="col-xl-3 col-sm-4 mb-3">
            <div class="card text-white bg2-primary o-hidden h-100">
              <div class="card-body">
                <div class="card-body-icon" href="#">
                </div>
                <div class="mr-1">Haven't you joined an apartment yet??</div>
             <img src="images/home.png" height="100" width="100" alt="bills logo" href="#">
                   <div class="mr-5"><h1> </h1></div>
                  
              </div>
              <a class="card-footer text-white clearfix small z-1" href="homepage_after_register.php">

 <span class="float-left">Click here :) </span>                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
              </a>
            </div>
      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright © ShareApart 2019</span>
          </div>
        </div>
      </footer>
